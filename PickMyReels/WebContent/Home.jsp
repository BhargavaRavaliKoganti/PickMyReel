...
<body>
	...
	<div class="wrap">
		<div class="page">
			...
			<div>
      			...
      			<li><a href="Login.jsp"><font color="white"><span class="glyphicon glyphicon-blackboard"></span>MyAccount</font></a></li>
      			</ul>
    			</div>
			</nav>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img class="first-slide" src="./images/Maleficent.png"
					...
					<div class="item">
						<img class="second-slide" src="./images/hobbit.png"
					...
					<div class="item">
						<img class="third-slide" src="./images/avengers2.png"
	...
	<div class=well-lg size=70px style="background-color: #313637; margin-top: 1px"> 
