			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img class="first-slide" src="./images/BajrangiBhaijaan.png"
					...
					<div class="item">
						<img class="second-slide" src="./images/spongebob.png"
					...
					<div class="item">
						<img class="third-slide" src="./images/home.png" alt="Third slide"
			...
			<div class="d3">
				...
				<div class="poster_wrap">
					<div class="p_box left" id="p1"
						style="background-image: url(./images/zootopia.png)">
						<span class="p_title">Zootopia</span>
					</div>
					<div class="p_box" id="p2"
						style="background-image: url(./images/5wave.png)">
						<span class="p_title">The 5th wave</span>
					</div>
					<div class="p_box left" id="p3"
						style="background-image: url(./images/dory.png)">
						<span class="p_title">Finding Dory</span>
					</div>
					<div class="p_box" id="p4"
						style="background-image: url(./images/sinister.png)">
						<span class="p_title">Sinister 2</span>
