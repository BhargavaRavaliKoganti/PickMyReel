...
<html>
 ...
 %> </a> </font> <%
 	...
 	Map urlpaths = (Map) session.getAttribute("orgurlpaths");
 ...
 %> <br> </font>
				...
				<br>
				<a
					href="./CrawlerWarningBirdUrl.jsp?value=<%=value%>&url=<%=request.getParameter("url")%>">
					<%=treeMap.get(value)%> </a>
			</center>
			<%
				//break;
